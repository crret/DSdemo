...
public class RightLightAttack02 : StateMachineBehaviour
{
    private PlayerAttacker playerAttacker;
    [SerializeField]
    private int TransitionFlag=0;
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        playerAttacker.inRightLightAttack02 = true;
        TransitionFlag=0;
    }
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        if (animator.IsInTransition(0) && TransitionFlag==1)
        {
            ...
            playerAttacker.inRightLightAttack02 = false;
        }
    }
